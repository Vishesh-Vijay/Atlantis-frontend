...
const Popover = ({title,description,handleSubmit, button1text, trigger}:PopoverProps) => {
  return (
    <div>
      <Dialog>
          <DialogContent className="sm:max-w-[425px]">
            ...
            <DialogFooter className="">
              ...
              <Button type="submit" className="bg-purple-900" onClick={handleSubmit}>{button1text}</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
    </div>
